...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="main">
        ...
        <section id="Introduction" class="Content">
            ...
            <p>
                Electrics workshop introduces the fundamental knowledge of an 
                electronic circuit as well as the application of Arduino with 
                sensors. Students also get hands-on experience during the workshop 
                in which they learn how to wire a simple Arduino board circuit and 
                using TinkerCad website as simulation or real electric components.   
            </p>
            <img style="width: 780px;height: 440px;"
                src="https://images.unsplash.com/photo-1528752511608-fbec4b6ea67f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=776&q=80"/>
        </section>
        ...
        <section id="WhatYouWillLearn" class="Content">
            ...
            <ol start="1">
              <li>Fundamental electronic components such as LED, resistor, distance sensor, and Arduino.</li>
              <li>How to wire or connect the components using TinkerCad.</li>
              <li>(Optional) Hands-on experience wiring the actual electronic board using Arduino to turn on/off the LED.</li>
            </ol> 
        </section>
        ...
        <section id="WhatYouNeedToPrepare" class="Content">
            ...
            <p>
                Revise the knowledge of a direct current diagram, the basic 
                one is a resistor connected with a voltage supplier.
            </p>
        </section>
