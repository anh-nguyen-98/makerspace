                        ...
                        <td runat="server">
                            <div id="project_card">
                                ...
                                <div id="headline">
                                    ...
                                    <p id="project_span">
                                        <asp:Label runat="server" Text='<%# (int)Eval("ongoing") == 1 ? String.Concat(Eval("begin_date").ToString().Split()[0], " - Present") : String.Concat(Eval("begin_date").ToString().Split()[0], " - ", Eval("end_date").ToString().Split()[0])%>'></asp:Label> 
                                    </p>
