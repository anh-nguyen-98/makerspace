...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class= "cover-align" style="width:100vw; height: 500px; position:relative" >
        ...
        <h3 class="image-cover" style="position: relative; background-color: white; top: 50px; text-align: center; color: #00196E; padding-top: 20px; padding-bottom: 20px; opacity: 0.7;">Served for DST A Class: 9:45AM - 11:15AM</h3>
    </div>
